...
class SwinFuse(nn.Module):
    def __init__(self, img_size=224, patch_size=1, in_chans=1, out_chans=1,
        ...
        print("SwinTransformerSys expand initial----depths:{};drop_path_rate:{};out_chans:{}".format(
                depths,
    ...
    # Fusion
    def fusion(self, en1, en2, p_type="l1_mean"):
        # attention weight
...
if __name__ == "__main__":
    ...
    net = SwinFuse(img_size=img_size, patch_size=patch_size).cuda()
